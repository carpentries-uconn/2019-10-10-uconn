...
address: "Visualization Studio (Rm 1101), Homer Babbidge Library, 369 Fairfield Way, Storrs, CT 06269"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"         # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"        # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "41.806732,-72.251826" # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Oct 10-11, 2019" # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Thu 4:30 pm - 8:30 pm, Fri 8:30 am - 4:30 pm" # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Dyanna Louyakis", "Kendra Maas", "Tim Moore", "Pariksheet Nanda", "Jeremy Teitelbaum", "Renee Walsh"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dipanjana Dalui"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["timothy.e.moore@uconn.edu", "renee.walsh@uconn.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2019-10-10-uconn" # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
